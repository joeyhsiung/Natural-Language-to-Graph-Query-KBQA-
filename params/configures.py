...
class Config_path:
    ...
    train_web = os.path.join(current_path, 'WebQSP/data/WebQSP.train.json')  ###################
    test_web = os.path.join(current_path, 'WebQSP/data/WebQSP.test.json')  ###################
...
class Config_output_path:
    parent_path = os.path.abspath(os.path.dirname(os.path.dirname(__file__)))
    current_path = os.path.join(parent_path, 'multiHop_QA/models')

    ner_data_path = os.path.join(parent_path, 'data')
    transformers_path = os.path.join(parent_path, 'multiHop_QA/models')
